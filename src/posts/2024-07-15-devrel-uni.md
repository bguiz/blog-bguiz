...
The program is organised by [Bianca Buzea](https://x.com/buzea200), and boasts an impressive lineup of speakers: [Steph Orpilla](https://x.com/0ceans404), [Patrick Collins](https://x.com/PatrickAlphaC), [Austin Griffith](https://x.com/austingriffith), [Nader Dabit](https://x.com/dabit3), and [Michiel Mulders](https://x.com/michiel_mulders). They are seasoned pros in the web3 DevRel space, and imparted a wealth of knowledge and experience to us.
...
I have always been an occasional Twitter user. I default to spending more time writing code. See [ShipTalkers](https://shiptalkers.dev/compare?name=bguiz) + [context on twitter](https://x.com/bguiz/status/1799375655702036990). But that is a vestige of my being a software engineer prior. I’ve come to realise just how important being active on Twitter is for DevRel, especially in web3. DevRel Uni’s Twitter task was actually fun, and I ended up producing a [mega Twitter thread](https://x.com/bguiz/status/1790231257244438853). Also, here’s a [Twitter list of the entire DevRel Uni 2024 batch](https://x.com/i/lists/1797917799312166951), follow us!

![](/images/posts/devreluni-2024--twitter-1.png) ![](/images/posts/devreluni-2024--twitter-2.png)

**Build and learn in public**

[Shawn Wang](https://twitter.com/swyx) (a fellow Singaporean 🙌) has an amazing article, [*Learn in Public*](https://www.swyx.io/learn-in-public). I have read this years ago, but never put it into practice. DevRel Uni gave me the all-too-important push to finally get onto this. This took the form of starting a [YouTube channel dedicated to Hands-on DevRel](https://www.youtube.com/@doDevRel?sub_confirmation=1). I record myself doing everyday DevRel tasks, narrating my thought process. Plus, occasionally throw in some tips.
...
There was a rather interesting moment around 2 weeks into the program. [I discovered, through memes,](https://x.com/bguiz/status/1796895069154500983) that I had two of my batch mates that I had interacted with before! They had attended a [webinar that I gave on DevRel as a profession](https://www.youtube.com/watch?v=KUeYpkY1ihU&list=PLjyCRcs63y83k_a41HpcmHIKlMkiahACK) only months before.
...
Repurpose content for maximum reuse[^devrel-do-things-for-multiple-reasons]. Turn the same thing into a demo repo, an article, a workshop, a conference talk, et cetera. Also, build in public and share your learning journey. (This validates Shawn Wang’s philosophy.)
...
Use frameworks or methodologies when planning developer documentation. Use resources like [Diátaxis](https://diataxis.fr/) and [The Good Docs Project](https://thegooddocsproject.dev/about/).
...
DevRel exists as a team within a tech company. As a relatively new function, DevRel is less well understood by the rest of the company. It may even be considered to niche by some. This poses unique challenges [^devrel-always-educate-up]. However, these were only briefly touched upon.
...
which I missed/ glossed over from the same sessions.
(Hive-mind, FTW!)
...
- [Fabian Weber](https://mirror.xyz/fabbaist.box/VMnrH5PAKfd36ud2SlDkOv0bVbiq3g7YvSh8kOO-yAE)
...
- [Progress Ochuko Eyaadah](https://medium.com/@devkoxy/my-devrel-uni-cohort-5-journey-3530699b50c3)
...
[^devrel-do-things-for-multiple-reasons]: One of my commonly repeated phrases is “in DevRel, never do anything for just one reason." (Ask anyone who has worked with me, to confirm.) It was great that Nader validated this.

[^devrel-always-educate-up]: Another one of my commonly repeated phrases is "In DevRel, you always gotta be educating up."

[^async-over-sync-for-hackathons]: One exception to this, IMHO, are hackathons. The ROI distinction between online and in-person hackathons is not as clear, and can be more variable.
